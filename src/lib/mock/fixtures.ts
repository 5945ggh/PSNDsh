...
export const MOCK_EXPENSE_CATEGORIES: ExpenseCategory[] = [
  { id: "cat_food", name: "默认餐饮", archivedAt: null },
  { id: "cat_transport", name: "默认交通", archivedAt: null },
  { id: "cat_other", name: "默认其他", archivedAt: null },
];

export const MOCK_EXPENSE_TAGS: ExpenseTag[] = [
  { id: "tag_school", name: "默认校园", archivedAt: null },
  { id: "tag_travel", name: "默认出行", archivedAt: null },
  { id: "tag_shopping", name: "默认购物", archivedAt: null },
];

export const MOCK_PAYMENT_METHODS: PaymentMethod[] = [
  { id: "pm_wechat", name: "默认微信", archivedAt: null },
  { id: "pm_alipay", name: "默认支付宝", archivedAt: null },
  { id: "pm_card", name: "默认校园卡", archivedAt: null },
];

export const MOCK_EXPENSES: Expense[] = [
  {
    id: "exp_pending_lunch",
    amountCents: 1_580,
    currency: "CNY",
    occurredAt: "2026-06-26T11:42:00+08:00",
    occurredOn: null,
    occurredTimezone: "Asia/Shanghai",
    occurrencePrecision: "datetime",
    recordedAt: "2026-06-26T12:00:00+08:00",
    captureMessage: "午饭",
    note: null,
    categoryId: null,
    ...
    longitude: null,
    deletedAt: null,
    createdAt: "2026-06-26T12:00:00+08:00",
  ...
  },
  {
    ...
    recordedAt: "2026-06-26T12:05:00+08:00",
    captureMessage: "奶茶",
    note: "下午补给",
    categoryId: "cat_other",
    paymentMethodId: "pm_wechat",
    tags: [
      { id: "tag_school", name: "校园", archivedAt: null },
    ],
    reviewStatus: "pending",
    recognitionStatus: "recognized",
    recoverableCents: 0,
    ...
    longitude: null,
    deletedAt: null,
    createdAt: "2026-06-26T12:05:00+08:00",
    updatedAt: "2026-06-26T12:05:00+08:00",
  },
  {
    id: "exp_reviewed_bus",
    amountCents: 300,
    currency: "CNY",
    occurredAt: "2026-06-24T08:05:00+08:00",
    occurredOn: null,
    occurredTimezone: "Asia/Shanghai",
    occurrencePrecision: "datetime",
    recordedAt: "2026-06-24T08:06:00+08:00",
    captureMessage: "地铁",
    note: null,
    categoryId: "cat_transport",
    paymentMethodId: "pm_alipay",
    tags: [
      { id: "tag_travel", name: "出行", archivedAt: null },
    ],
    ...
    longitude: null,
    deletedAt: null,
    createdAt: "2026-06-24T08:06:00+08:00",
    updatedAt: "2026-06-24T08:08:00+08:00",
  },
  {
    id: "exp_reviewed_books",
    amountCents: 4_250,
    currency: "CNY",
    occurredAt: "2026-06-22T16:20:00+08:00",
    occurredOn: null,
    occurredTimezone: "Asia/Shanghai",
    occurrencePrecision: "datetime",
    recordedAt: "2026-06-22T16:30:00+08:00",
    captureMessage: "买书",
    note: "课程参考书",
    categoryId: "cat_other",
    ...
    tags: [
      { id: "tag_school", name: "校园", archivedAt: null },
      { id: "tag_shopping", name: "购物", archivedAt: null },
    ],
    reviewStatus: "reviewed",
    recognitionStatus: "recognized",
    recoverableCents: 0,
    ...
    longitude: null,
    deletedAt: null,
    createdAt: "2026-06-22T16:30:00+08:00",
    updatedAt: "2026-06-22T17:00:00+08:00",
  },
];
